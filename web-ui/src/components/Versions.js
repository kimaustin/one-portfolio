...
const Versions = ({ drawerToggle, toggle }) => {
    ...
    return (
        ...
        as={motion.div} 
            ...
            <Drawer>
                {/* <Item style={{color: 'white', userSelect: 'none'}}>_</Item> */}
                <Item onClick={() => window.location='http://realitycomposer.online'} target="blank">v3 (2024)</Item>
                ...
                <Item style={{ pointerEvents: "none", color: 'grey', background: '#F3F3F3' }}>v1 (current, 2022)</Item>
            </Drawer>
